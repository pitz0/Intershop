...
for child in root:         #loops for each child
	...
	for element in child:   #loops for element is child
		...
		if element.tag in ["GnCode","ItemCode","MfgCode","HPRate","Rate","MRP","HMARGIN","RMARGIN","TAX","MST","CST","OCT","EXICE"]:
			element.attrib={"name":element.tag, "type":"PositiveInteger"}
			
		elif element.tag in ["PACK","Descr","STRENGTH","MFG","CATEGORY","PIS","PISNO"]:
